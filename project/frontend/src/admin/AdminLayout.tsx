...
import { FiUsers, FiSettings, FiHome, FiPackage, FiGrid, FiShoppingBag, FiBox, FiClipboard } from 'react-icons/fi';
...
export default function AdminLayout() {
    ...
    const menuItems = [
        ...
        { path: '/admin/categories', label: 'Accounting', icon: <FiGrid size={20} /> },
        { path: '/admin/branding', label: 'Branding', icon: <FiPackage size={20} /> },
        { path: '/admin/settings', label: 'Settings', icon: <FiSettings size={20} /> },
        { path: '/admin/purchaseview', label: 'Purchase View', icon: <FiPackage size={20} /> },
        { path: '/admin/salesview', label: 'Sales View', icon: <FiPackage size={20} /> },
    ];
    ...
    return (
        <div className="flex h-screen w-screen bg-[#E8F5E9] overflow-hidden">
                ...
                <nav className="mt-6">
                    {menuItems.map((item) => (
                        ...
                        >
                            ...
                            <span className={`ml-4 font-medium whitespace-nowrap transition-opacity duration-300 ${
            ...
            {/* Main Content */}
            <div 
                className={`flex-1 transition-all duration-300 ${isHovered ? 'ml-64' : 'ml-16'}`}
            >
